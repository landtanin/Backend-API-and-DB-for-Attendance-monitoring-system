...
class Functions{
    ...
    public function registerUser($name, $student_id, $email, $password) {
        ...
        if (!empty($name) && !empty($student_id) && !empty($email) && !empty($password)) {
            ...
            if ($db -> checkUserExist($email)) {
                ...
                $result = $db -> insertData($name, $student_id, $email, $password);
        ...
        if (!empty($email) && !empty($password)) {
            ...
            if ($db -> checkUserExist($email)) {
                ...
                if(!$result) {
                    ...
                    $response["result"] = "failure";
                    $response["message"] = "Invaild Email of Password";
                    return json_encode($response);
